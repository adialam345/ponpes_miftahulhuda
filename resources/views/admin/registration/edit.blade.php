...
<div class="py-6 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div class="mb-4">
            <h1 class="text-2xl font-semibold text-gray-900">Edit Halaman Pendaftaran</h1>
            <p class="text-sm text-gray-600">Perbarui informasi halaman pendaftaran</p>
        </div>
        ...
        <form action="{{ route('admin.registration.update', $registrationPage->id) }}" method="POST">
            ...
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="md:w-2/3">
                    <div class="bg-white shadow-sm rounded-md overflow-hidden mb-6">
                        <div class="p-6">
                            <!-- Tipe Halaman -->
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-1">Tipe Halaman</label>
                                <div class="relative">
                                    <select name="page_type" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm rounded-md" required>
                                        <option value="pondok" {{ $registrationPage->page_type == 'pondok' ? 'selected' : '' }}>Pendaftaran Pondok</option>
                                        <option value="smp" {{ $registrationPage->page_type == 'smp' ? 'selected' : '' }}>Pendaftaran SMP</option>
                                    </select>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="title" value="{{ old('title', $registrationPage->title) }}" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                @error('title')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="registration_start" value="{{ old('registration_start', $registrationPage->registration_start ? $registrationPage->registration_start->format('Y-m-d') : '') }}" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="registration_end" value="{{ old('registration_end', $registrationPage->registration_end ? $registrationPage->registration_end->format('Y-m-d') : '') }}" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                    ...
                    <div class="bg-white shadow-sm rounded-md overflow-hidden mb-6">
                        <div class="border-b border-gray-200 px-4 py-3">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Konten Halaman</h3>
                        ...
                        <div class="p-4">
                            ...
                            <div id="editor-container" class="min-h-[300px] max-h-[600px] overflow-y-auto p-4 border border-gray-300 rounded-b-md bg-white focus:outline-none" contenteditable="true" style="font-family: Arial, sans-serif; font-size: 14px;">
                                {!! old('content', $registrationPage->content) !!}
                            </div>
                ...
                <div class="md:w-1/3">
                    <div class="bg-white shadow-sm rounded-md overflow-hidden mb-6">
                        ...
                        <div class="p-4">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ \App\Http\Controllers\RegistrationController::isRegistrationOpen($registrationPage) ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                                    {{ \App\Http\Controllers\RegistrationController::isRegistrationOpen($registrationPage) ? 'Terbuka' : 'Tertutup' }}
                                </span>
                            </div>
                            <div class="flex items-center justify-between mb-4">
                                <span class="text-sm font-medium text-gray-700">Terakhir diperbarui:</span>
                                <span class="text-sm text-gray-500">{{ $registrationPage->updated_at->format('d M Y H:i') }}</span>
                            </div>
                    ...
                    <div class="bg-white shadow-sm rounded-md overflow-hidden mb-6">
                        <div class="border-b border-gray-200 px-4 py-3">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Pratinjau</h3>
                        </div>
                        <div class="p-4">
                            <a href="{{ route('registration.show', ['type' => $registrationPage->page_type]) }}" target="_blank" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
